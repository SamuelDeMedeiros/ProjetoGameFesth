...
namespace ProjetoE_CommerceGameFesth.Repository
{
    public class ClienteRepository : IClienteRepository
    {
        ...
        public void Ativar(int id)
        {
            ...
            {
                conexao.Open();
                MySqlCommand cmd = new MySqlCommand("update Tb_Cliente set Situacao=@situacao where Id=@id", conexao);
        ...
        public Cliente ObterCpfCliente(string CPF)
        {
            ...
            {
                conexao.Open();
                MySqlCommand cmd = new MySqlCommand("select cpf from Tb_cliente where cpf=@cpf",conexao);
        ...
        public Cliente ObterEmailCliente(string email)
        {
            ...
            {
                conexao.Open();
                MySqlCommand cmd = new MySqlCommand("select Email from Tb_cliente where Email=@email", conexao);
                cmd.Parameters.AddWithValue("@email", email);
                MySqlDataAdapter da = new MySqlDataAdapter(cmd);
                MySqlDataReader dr;
                Cliente cliente = new Cliente();
        ...
        public void AtualizarSenha(Cliente cliente)
        {
            ...
            {
                conexao.Open();
                MySqlCommand cmd = new MySqlCommand("update Tb_login set Senha=@Senha where Id=@id", conexao);
        ...
        public void Cadastrar(CadastraEndereco cadastraEndereco)
        {
            ...
            using (var conexao = new MySqlConnection(_conexaoMySQL))
            {
                MySqlCommand cmd;
                conexao.Open();
                if (cadastraEndereco.cliente.CPF == null)
                {
                    ...
                    cmd.Parameters.Add("@Nascimento", MySqlDbType.DateTime).Value = cadastraEndereco.cliente.Nascimento.ToString("yyyy/MM/dd");
                    cmd.Parameters.Add("@Sexo", MySqlDbType.VarChar).Value = cadastraEndereco.cliente.Sexo;
                    cmd.Parameters.Add("@Telefone", MySqlDbType.Int32).Value = cadastraEndereco.cliente.Telefone.Replace("(", "").Replace(")", "").Replace(" ", "").Replace("-", "");
                    cmd.Parameters.Add("@Rg", MySqlDbType.Int32).Value = cadastraEndereco.cliente.RG.Replace(".", "").Replace("-", "");
                    cmd.Parameters.Add("@CPF", MySqlDbType.Int64).Value = cadastraEndereco.cliente.CPF.Replace(".", "").Replace("-", "");
                    cmd.Parameters.Add("@CEP", MySqlDbType.Int32).Value = cadastraEndereco.endereco.CEP.Replace("-", "");
                    cmd.Parameters.Add("@Logradouro", MySqlDbType.VarChar).Value = cadastraEndereco.endereco.Lougradouro;
                    cmd.Parameters.Add("@Num", MySqlDbType.Int32).Value = cadastraEndereco.endereco.NumLougradouro;
                ...
                else
                {
                    ...
                    cmd.Parameters.Add("@Sexo", MySqlDbType.VarChar).Value = cadastraEndereco.cliente.Sexo;
                    cmd.Parameters.Add("@Telefone", MySqlDbType.Int32).Value = cadastraEndereco.cliente.Telefone.Replace("(", "").Replace(")", "").Replace(" ", "").Replace("-", "");
                    cmd.Parameters.Add("@Cnpj", MySqlDbType.Int64).Value = cadastraEndereco.cliente.CNPJ.Replace(".", "").Replace("/", "").Replace("-", "");
        ...
        public void Excluir(int Id)
        {
            ...
            {
                conexao.Open();
                MySqlCommand cmd = new MySqlCommand("delete from Tb_Cliente where Id=@id", conexao);
